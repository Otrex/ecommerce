...
router.post('/verify-email', authentication(TOKEN_FLAG.EMAIL_VERIFY), AuthController.verifyEmail);
router.post('/reset-password', authentication(TOKEN_FLAG.RESET), AuthController.passwordReset);
